...
*/
void EntityParent(Entity* ent,Entity* parent_ent,bool glob=0);
...
*/
float EntityPitch(Entity* ent,bool glob=0);
...
*/
float EntityRoll(Entity* ent,bool glob=0);
...
*/
void PositionEntity(Entity* ent,float x,float y,float z,bool glob=0);
...
*/
void RotateEntity(Entity* ent,float x,float y,float z,bool glob=0);
...
*/
void ScaleEntity(Entity* ent,float x,float y,float z,bool glob=0);
...
*/
void TranslateEntity(Entity* ent,float x,float y,float z,bool glob=0);
...
*/
void TurnEntity(Entity* ent,float x,float y,float z,bool glob=0);
...
float EntityScaleX(Entity* ent,bool glob=0);

float EntityScaleY(Entity* ent,bool glob=0);

float EntityScaleZ(Entity* ent,bool glob=0);
